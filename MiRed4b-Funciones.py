...
def obtener_genero():
    ...
    return genero
def obtener_paisNac():
    paisNac = input("Pais nacimiento: ")
    return paisNac

def mostrar_perfil(nombre, edad, estatura_m, estatura_cm, num_amigos, genero, paisNac):
    print("--------------------------------------------------")
    print("Nombre:   ", nombre)
...
paisNac = obtener_paisNac()
print("Muy bien,", nombre, ". Entonces podemos crear un perfil con estos datos.")
mostrar_perfil(nombre, edad, estatura_m, estatura_cm, num_amigos, genero, paisNac)
