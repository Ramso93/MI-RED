...
#adicional
genero = input("Indique el genero al que pertenece(Masculino/Femenino/NS):")
num_telf = input("Número de telefono: ")
pais_nac = input("Pais de nacimiento: ")
...
print("Genero:  ", genero)
print("Número de telefono:  ", num_telf)
print("Pais de nacimiento:  ", pais_nac)
print("--------------------------------------------------")
